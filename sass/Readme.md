...
folder are mapped to the application's root namespace, 'Lab121'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Lab121' in the same way
as `"Lab121/sass/src"`.
